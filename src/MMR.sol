...
library MMR {
    ...
    function getMerkleProof(Tree storage tree, uint256 index)
        public
        view
        returns (bytes32 root, uint256 width, bytes32[] memory peakBagging, bytes32[] memory siblings)
    {
    ...
    function rollUp(bytes32 root, uint256 width, bytes32[] memory peaks, bytes32[] memory itemHashes)
        public
        pure
    ...
    function peaksToPeakMap(uint256 width, bytes32[] memory peaks) public pure returns (bytes32[255] memory peakMap) {
        uint256 bitIndex;
        uint256 peakRef;
    ...
    function peakMapToPeaks(uint256 width, bytes32[255] memory peakMap) public pure returns (bytes32[] memory peaks) {
    ...
    function peakUpdate(uint256 width, bytes32[255] memory prevPeakMap, bytes32 itemHash)
        public
        pure
        returns (bytes32[255] memory nextPeakMap)
    {
